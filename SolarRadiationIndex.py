...
class SolarRadiationIndex():
    ...
    def __init__(self):
        ...
        self.description = ("Calculates a Simple Solar Radiation Index based on slope, "
                            "aspect and latitude")
    ...
    def getParameterInfo(self):
        return [
            ...
            },
            {
                ...
                'description': ("A raster of latitude values for each cell, in degrees north "
    ...
    def updateRasterInfo(self, **kwargs):
        ...
        kwargs['output_info']['statistics'] = ({'minimum': 0.0, 'maximum': 1.0}, )  # we know something about the stats of the outgoing HeatIndex raster.
